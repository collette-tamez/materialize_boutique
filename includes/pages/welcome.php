...
<div class="parallax-container">
    <div class="parallax">
        <img src="assets/images/welcome-image.png" id="heroImage">
    </div>
</div>
<!--main do hickies-->
<main class="section container">
    <div class="section row">
        <img src="assets/images/macarons-image.png" class="hide-on-small-only col m4 l3">
        <div class="col sm12 m8 l9" id="mainText">
    ...
    <div class="row mainText hide-on-med-and-down">
        <div class="card-panel small col m1">
            <p>Monday</p>
        ...
        <div class="card-panel small col m1">
            ...
            <p>raspbery <img src="assets/images/raspbery.png" class="right"></p>
